...
def ventana_provedores(notebook):
    ...
    tk.Button(caja2, text="Enviar Piezas", command= lambda: enviar_piezas_a_pulido(pieza_predeterminadas, cantidad_agregar_carmelo, "carmelo_pulido", arbol, result)).grid(row=4, column=1)    
    ...
    tk.Button(caja2, text="Stock Total",command=lambda: mostrar_datos(arbol, "carmelo_pulido")).grid(row=6, column=0 ,columnspan=2)
    
    botonera = ttk.Frame(caja2)
    botonera.grid(row=7,column=0, columnspan=2)
    
    tk.Button(botonera, text="Stock 330", command= lambda: mostrar_datos_especifico("carmelo_pulido", "330", arbol)).grid(row=0, column=0)
    tk.Button(botonera, text="Stock 300", command= lambda: mostrar_datos_especifico("carmelo_pulido", "300", arbol)).grid(row=0, column=1)
    tk.Button(botonera, text="Resto De Piezas", command= lambda: mostrar_datos_especifico("carmelo_pulido", "all", arbol)).grid(row=0, column=2)
    ...
    tk.Button(caja2, text="Piezas Terminadas", command=lambda: mover_piezas_a_stock_pulidas(pieza_predeterminadas1, cantidad_piezas_terminadas_carmelo, "carmelo_pulido", "piezas_finales_defenitivas", arbol, result)).grid(row=11, column=1)
    
    #------------------------------------------------------------------------------#
    ttk.Separator(caja2, orient="horizontal").grid(row=12, column=0, columnspan=2, sticky="ew", padx=5, pady=5 )
    ...
    tk.Button(caja2, text="Enviar Piezas", command=lambda: enviar_piezas_a_pulido(pieza_predeterminadas2, cantidad_agregar_maxi, "maxi_pulido", arbol, result)).grid(row=16, column=1)    
    
    #___________________consulta stock_________________________________________#
    tk.Label(caja2, text="Consultas De Stock").grid(row=17, column=0, sticky="w")
    
    tk.Button(caja2, text="Stock Total", command=lambda:mostrar_datos(arbol, "maxi_pulido")).grid(row=18, column=0 ,columnspan=2)
    
    botonera = ttk.Frame(caja2)
    botonera.grid(row=19,column=0, columnspan=2)
    
    tk.Button(botonera, text="Stock 300", command= lambda: mostrar_datos_especifico("maxi_pulido", "330", arbol)).grid(row=0, column=0)
    tk.Button(botonera, text="Stock 330", command= lambda: mostrar_datos_especifico("maxi_pulido", "300", arbol)).grid(row=0, column=1)
    tk.Button(botonera, text="Resto De Piezas", command= lambda: mostrar_datos_especifico("maxi_pulido", "250", arbol)).grid(row=0, column=2)
    ...
    tk.Button(botonera, text="Stock 300", command= lambda: mostrar_datos_especifico("buenhombre_pulido", "330", arbol)).grid(row=0, column=0)
    tk.Button(botonera, text="Stock 330", command= lambda: mostrar_datos_especifico("buenhombre_pulido", "300", arbol)).grid(row=0, column=1)
    tk.Button(botonera, text="Resto De Piezas", command= lambda: mostrar_datos_especifico("buenhombre_pulido", "all", arbol)).grid(row=0, column=2)
    ...
    #------------------------------------------------------------------------------#
    ttk.Separator(caja3, orient="horizontal").grid(row=12, column=0, columnspan=2, sticky="ew", padx=5, pady=5 )
    ...
    tk.Button(botonera2, text="Stock Total Bruto", command=lambda: mostrar_datos(arbol, "piezas_del_fundicion")).grid(row=1, column=0)
    tk.Button(botonera2, text="Stock Total Pulido", command=lambda: mostrar(arbol, "piezas_finales_defenitivas", "pulido")).grid(row=1, column=1)
    
    ttk.Separator(botonera2, orient="horizontal").grid(row=3, column=0, columnspan=3, sticky="ew", padx=5, pady=5)
    
    tk.Label(caja3, text="Niquelado").grid(row=14, column=1)
    tk.Button(caja3, text="Stock en bruto", command=lambda: mostrar(arbol, "piezas_del_fundicion", "niquelado")).grid(row=15, column=0)
    tk.Button(caja3, text="Stock niquelado", command=lambda: mostrar(arbol, "piezas_finales_defenitivas", "niquelado")).grid(row=15, column=1)
    ...
    tk.Button(caja3, text="Enviar", command=lambda: envios_de_bruto_a_pulido(lista_piezas.get(), cantidad_a_niquelar, result, arbol, "niquelado")).grid(row=18, column=1 , columnspan=2)
    
    ttk.Separator(caja3, orient="horizontal").grid(row=19, column=0, columnspan=2, sticky="ew", padx=5, pady=5)
    ...
    tk.Button(caja4, text="Stock en fabrica", command=lambda: mostrar(arbol,"piezas_del_fundicion", "pintor")).grid(row=1, column=0)
    tk.Button(caja4, text="Stock en Pintura", command=lambda: mostrar(arbol, "piezas_finales_defenitivas", "pintor")).grid(row=1, column=1)
    ...
    tk.Button(caja4, text="Enviar", command=lambda: envios_de_bruto_a_pulido(modelo.get(), enviar_a_pintura, result, arbol, "pintor")).grid(row=5, column=1)
    ...
    tk.Button(caja4, text="enviar", command=lambda: envios_de_bruto_a_pulido("cabezal_pintura", cantidad_cabezales, result, arbol, "pintor")).grid(row=7, column=1)
    
    ttk.Separator(caja4, orient="horizontal").grid(row=8, column=0, columnspan=2, sticky="ew", padx=5, pady=5)
    ...
    tk.Button(caja4, text="Enviar", command=lambda: agregar_a_lista_tarea(caja_texto, result)).grid(row=16, column=1, sticky="e")
