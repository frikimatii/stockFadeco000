...
def ventana_fundidor(notebook):
    ...
    tk.Listbox
    boton_mostrar_datos_fundidor = ttk.Button(
        caja1,
        text="Mostras Datos",
    ...
    ttk.Label(caja3, text="Tornillos", font=("Arial", 12, "bold")).grid(
        row=11, column=1, padx=3, pady=3
    )
    ...
    predefinidas_tornillo_delete = ttk.Combobox(
        caja3, values=tornilleria, state="readonly"
    )
